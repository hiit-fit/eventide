...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): Event {
      ...
      val attendees = pigeonVar_list[8] as List<Attendee>
      val description = pigeonVar_list[9] as String?
      val url = pigeonVar_list[10] as String?
      val location = pigeonVar_list[11] as String?
      return Event(id, calendarId, title, isAllDay, startDate, endDate, timezone, reminders, attendees, description, url, location)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
...
interface CalendarApi {
  ...
  fun createEvent(calendarId: String, title: String, startDate: Long, endDate: Long, timezone: String, isAllDay: Boolean, description: String?, url: String?, location: String?, reminders: List<Long>?, callback: (Result<Event>) -> Unit)
  fun createEventInDefaultCalendar(title: String, startDate: Long, endDate: Long, timezone: String, isAllDay: Boolean, description: String?, url: String?, location: String?, reminders: List<Long>?, callback: (Result<Unit>) -> Unit)
  fun createEventThroughNativePlatform(title: String?, startDate: Long?, endDate: Long?, timezone: String?, isAllDay: Boolean?, description: String?, url: String?, location: String?, reminders: List<Long>?, callback: (Result<Unit>) -> Unit)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            api.createEvent(calendarIdArg, titleArg, startDateArg, endDateArg, timezoneArg, isAllDayArg, descriptionArg, urlArg, locationArg, remindersArg) { result: Result<Event> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(CalendarApiPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val timezoneArg = args[3] as String
            ...
            api.createEventInDefaultCalendar(titleArg, startDateArg, endDateArg, timezoneArg, isAllDayArg, descriptionArg, urlArg, locationArg, remindersArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(CalendarApiPigeonUtils.wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val locationArg = args[7] as String?
            val remindersArg = args[8] as List<Long>?
            api.createEventThroughNativePlatform(titleArg, startDateArg, endDateArg, timezoneArg, isAllDayArg, descriptionArg, urlArg, locationArg, remindersArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(CalendarApiPigeonUtils.wrapError(error))
              } else {
