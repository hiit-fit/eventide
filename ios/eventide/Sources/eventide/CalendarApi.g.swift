...
struct Event: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> Event? {
    ...
    let timezone = pigeonVar_list[6] as! String
    let reminders = pigeonVar_list[7] as! [Int64]
    let attendees = pigeonVar_list[8] as! [Attendee]
    let description: String? = nilOrValue(pigeonVar_list[9])
    let url: String? = nilOrValue(pigeonVar_list[10])
    let location: String? = nilOrValue(pigeonVar_list[11])
...
protocol CalendarApi {
  ...
  func createEvent(calendarId: String, title: String, startDate: Int64, endDate: Int64, timezone: String, isAllDay: Bool, description: String?, url: String?, location: String?, reminders: [Int64]?, completion: @escaping (Result<Event, Error>) -> Void)
  func createEventInDefaultCalendar(title: String, startDate: Int64, endDate: Int64, timezone: String, isAllDay: Bool, description: String?, url: String?, location: String?, reminders: [Int64]?, completion: @escaping (Result<Void, Error>) -> Void)
  func createEventThroughNativePlatform(title: String?, startDate: Int64?, endDate: Int64?, timezone: String?, isAllDay: Bool?, description: String?, url: String?, location: String?, reminders: [Int64]?, completion: @escaping (Result<Void, Error>) -> Void)
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: CalendarApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      createEventChannel.setMessageHandler { message, reply in
        ...
        api.createEvent(calendarId: calendarIdArg, title: titleArg, startDate: startDateArg, endDate: endDateArg, timezone: timezoneArg, isAllDay: isAllDayArg, description: descriptionArg, url: urlArg, location: locationArg, reminders: remindersArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
    ...
    if let api = api {
      createEventInDefaultCalendarChannel.setMessageHandler { message, reply in
        ...
        let timezoneArg = args[3] as! String
        ...
        api.createEventInDefaultCalendar(title: titleArg, startDate: startDateArg, endDate: endDateArg, timezone: timezoneArg, isAllDay: isAllDayArg, description: descriptionArg, url: urlArg, location: locationArg, reminders: remindersArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
    ...
    if let api = api {
      createEventThroughNativePlatformChannel.setMessageHandler { message, reply in
        ...
        let timezoneArg: String? = nilOrValue(args[3])
        let isAllDayArg: Bool? = nilOrValue(args[4])
        let descriptionArg: String? = nilOrValue(args[5])
        let urlArg: String? = nilOrValue(args[6])
        let locationArg: String? = nilOrValue(args[7])
        let remindersArg: [Int64]? = nilOrValue(args[8])
        api.createEventThroughNativePlatform(title: titleArg, startDate: startDateArg, endDate: endDateArg, timezone: timezoneArg, isAllDay: isAllDayArg, description: descriptionArg, url: urlArg, location: locationArg, reminders: remindersArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
