...
class Event {
  ...
  static Event decode(Object result) {
    ...
    return Event(
      ...
      attendees: (result[8] as List<Object?>?)!.cast<Attendee>(),
      description: result[9] as String?,
      url: result[10] as String?,
      location: result[11] as String?,
    );
  }
...
class CalendarApi {
  ...
  Future<Event> createEvent({required String calendarId, required String title, required int startDate, required int endDate, required String timezone, required bool isAllDay, required String? description, required String? url, required String? location, required List<int>? reminders, }) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[calendarId, title, startDate, endDate, timezone, isAllDay, description, url, location, reminders]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<void> createEventInDefaultCalendar({required String title, required int startDate, required int endDate, required String timezone, required bool isAllDay, required String? description, required String? url, required String? location, required List<int>? reminders, }) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[title, startDate, endDate, timezone, isAllDay, description, url, location, reminders]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<void> createEventThroughNativePlatform({String? title, int? startDate, int? endDate, String? timezone, bool? isAllDay, String? description, String? url, String? location, List<int>? reminders, }) async {
